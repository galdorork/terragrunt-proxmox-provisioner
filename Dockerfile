...
RUN ln -s ~/go/bin/terraform-provider-proxmox    ~/.terraform.d/plugins/terraform.example.com/telmate/proxmox/1.0.0/linux_amd64/
RUN ln -s ~/go/bin/terraform-provisioner-proxmox ~/.terraform.d/plugins/terraform.example.com/telmate/proxmox/1.0.0/linux_amd64